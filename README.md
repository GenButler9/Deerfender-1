...
![Download Diagram](Images/Copy of ELK-Cyberlab.svg)
...
| Web Server 1 | Web Server | 10.0.0.10  | Linux (Ubuntu 18.04) |
| Web Server 2 | Web Server | 10.0.0.9   | Linux (Ubuntu 18.04) |
| Web Server 3 | Web Server | 10.0.0.4   | Linux (Ubuntu 18.04) |
...
|--------------|------------------------|-----------------------------------|
| Jump Box     | Yes (SSH ONLY - 22)    | 10.0.0.7                          |
| Web Server 1 | No                     | 40.127.86.243 - via Load Balancer |
| Web Server 2 | No                     | 40.127.86.243 - via Load Balancer |
| Web Server 3 | No                     | 40.127.86.243 - via Load Balancer |
...
- 10.0.0.10 - Web Server 1
- 10.0.0.9  - Web Server 2
- 10.0.0.4  - Web Server 3
